 ...
 */
function olesya_lite_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function olesya_lite_sanitize_css( $css ) {
 ...
 */
function olesya_lite_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function olesya_lite_sanitize_email( $email, $setting ) {
 ...
 */
function olesya_lite_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function olesya_lite_sanitize_html( $html ) {
 ...
 */
function olesya_lite_sanitize_image( $image, $setting ) {
 ...
 */
function olesya_lite_sanitize_nohtml( $nohtml ) {
 ...
 */
function olesya_lite_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function olesya_lite_sanitize_number_range( $number, $setting ) {
 ...
 */
function olesya_lite_sanitize_select( $input, $setting ) {
 ...
 */
function olesya_lite_sanitize_url( $url ) {
 ...
 */
function olesya_lite_sanitize_multicheck( $values ) {
