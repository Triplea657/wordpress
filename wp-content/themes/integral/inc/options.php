...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc' => __('Copy and paste the required icon class from the <a href="https://fontawesome.com/v4.7.0/icons/" target="_blank">Fontawesome Icons List</a> and choose from 600+ icons.', 'integral') ,
            'default' => 'fa-leaf',
        ) ,
        array(
            'id' => 'work-subtitle',
